...
MEDICAL_AUDIO = DatasetConfig(
    ...
    modality="audio",
    name="Medical Audio",
    description="Respiratory sound classification (cough, wheeze, crackle, etc.)",
    class_names=["cough", "sneeze", "wheeze", "normal", "crackle"],
...
WILDLIFE_AUDIO = DatasetConfig(
    ...
    modality="audio",
    name="Wildlife Audio",
    description="Animal sound classification (bird calls, marine life, etc.)",
    class_names=["bird_song", "frog", "insect", "mammal", "marine"],
...
URBAN_SOUNDS = DatasetConfig(
    ...
    modality="audio",
    name="Urban Sounds",
    description="Urban sound classification (sirens, traffic, construction, etc.)",
    class_names=[
...
MEDICAL_IMAGE = DatasetConfig(
    ...
    description="Medical image classification (X-rays, skin lesions, etc.)",
    class_names=[
        "normal", "pneumonia", "fracture", "tumor",
        "healthy_skin", "melanoma", "benign_lesion",
    ],
